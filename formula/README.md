# Jadawel Formula Language

This directory contains the [ANLTR Grammar](https://www.antlr.org/) for Jadawel's custom
formula language.
...
Jadawel's code. To do so run the `./build.sh` which using Docker will generate the 

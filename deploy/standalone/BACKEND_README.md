# Jadawel's Standalone Backend Image

This image runs only the Jadawel Backend service and is intended for use by advanced 
users. Please instead use the `jadawel/jadawel` image if you want a simpler setup.

See the project [README](../../README.md) and
[configuration docs](../../docs/CONFIGURATION.md) for more details.
...
* [`X.Y.Z`](../../backend/Dockerfile) Tagged by Jadawel version.
* [`latest`](../../backend/Dockerfile)

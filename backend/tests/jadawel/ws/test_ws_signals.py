...
@patch("jadawel.ws.signals.broadcast_to_group")
@patch("jadawel.ws.signals.broadcast_to_groups")
...
@pytest.mark.django_db(transaction=True)
@patch("jadawel.core.notifications.receivers.broadcast_to_users")
@patch("jadawel.ws.signals.broadcast_to_users")
@patch("jadawel.ws.signals.broadcast_to_group")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
# baserow_enterprise's role receiver is deliberately absent from this fork, so only
# the core broadcast is patched here — which is all this test asserts on.
@patch("jadawel.ws.signals.broadcast_to_group")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("jadawel.ws.signals.broadcast_application_created")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("jadawel.ws.signals.broadcast_to_permitted_users")
@pytest.mark.websockets
...
@pytest.mark.django_db(transaction=True)
@patch("jadawel.ws.signals.force_disconnect_users")
@pytest.mark.websockets

...
from jadawel.core.models import BlacklistedToken
from jadawel.core.user.exceptions import UserNotFound
from jadawel.core.user_sources.exceptions import UserSourceImproperlyConfigured
...
def test_refresh_json_web_token(api_client, data_fixture, stub_user_source_registry):
    ...
    with (
        patch("jadawel.api.user_sources.serializers.jwt_settings") as mocked_settings,

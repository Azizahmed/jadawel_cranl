...
from jadawel.api.user_sources.authentication import UserSourceJSONWebTokenAuthentication
...
def test_user_source_authentication_handles_deleted_application(
    ...
    with mock.patch(
        "jadawel.api.user_sources.authentication.CoreHandler.check_permissions",

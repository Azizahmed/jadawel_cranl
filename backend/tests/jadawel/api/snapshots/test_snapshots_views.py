...
from jadawel.core.jobs.constants import JOB_STARTED
from jadawel.core.jobs.models import JOB_STATES_RUNNING
from jadawel.test_utils.helpers import is_dict_subset
...
def test_get_current_snapshot_job(api_client, data_fixture):
    ...
    with patch("jadawel.core.jobs.tasks.run_async_job.delay"):
        response = api_client.post(
            url,
            {"name": snapshot_name},
            format="json",

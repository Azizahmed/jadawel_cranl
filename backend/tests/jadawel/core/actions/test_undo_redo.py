...
from jadawel.api.sessions import set_untrusted_client_session_id
...
from jadawel.core.action.scopes import RootActionScopeType, WorkspaceActionScopeType
...
from jadawel.core.models import WORKSPACE_USER_PERMISSION_ADMIN, Application, Workspace
...
def test_when_redo_fails_the_action_is_rolled_back(
    ...
    with patch(
        "jadawel.core.signals.workspace_deleted.send"

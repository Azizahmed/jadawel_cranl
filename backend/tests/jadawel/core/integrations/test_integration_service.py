...
from jadawel.core.integrations.exceptions import (
...
@patch("jadawel.core.integrations.service.integration_created")
...
@pytest.mark.django_db
@patch("jadawel.core.integrations.service.integration_orders_recalculated")
...
@pytest.mark.django_db
@patch("jadawel.core.integrations.service.integration_moved")

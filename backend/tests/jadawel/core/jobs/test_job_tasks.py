...
from jadawel.core.jobs.constants import (
    JOB_FAILED,
    JOB_FINISHED,
    JOB_PENDING,
    JOB_STARTED,
...
from jadawel.core.jobs.tasks import clean_up_jobs, run_async_job
...
@patch("jadawel.core.jobs.registries.JobTypeRegistry.get_by_model")

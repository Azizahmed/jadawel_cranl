...
from jadawel.core.import_export.exceptions import ImportExportResourceInvalidFile
...
@patch("jadawel.core.import_export.handler.application_created")
@patch("jadawel.core.import_export.handler.application_imported")
def test_import_workspace_applications_calls_signals(
    ...
    with patch(
        "jadawel.core.import_export.handler.ImportExportHandler.validate_signature"
    ):

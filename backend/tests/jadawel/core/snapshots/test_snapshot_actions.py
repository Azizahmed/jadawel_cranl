...
@patch(
    "jadawel.core.snapshots.job_types.CreateSnapshotJobType.transaction_atomic_context",
    new=contextlib.nullcontext,
)
@patch("jadawel.core.action.signals.action_done.send")
...
@pytest.mark.django_db
@patch(
    "jadawel.core.snapshots.job_types.RestoreSnapshotJobType.transaction_atomic_context",
    new=contextlib.nullcontext,
)
@patch("jadawel.core.action.signals.action_done.send")

...
from jadawel.core.app_auth_providers.exceptions import IncompatibleUserSourceType
from jadawel.core.app_auth_providers.models import AppAuthProvider
from jadawel.core.app_auth_providers.registries import app_auth_provider_type_registry
...
@patch("jadawel.core.user_sources.service.user_source_created")
...
@pytest.mark.django_db
@patch("jadawel.core.user_sources.service.user_source_orders_recalculated")
...
@pytest.mark.django_db
@patch("jadawel.core.user_sources.service.user_source_deleted")
...
@pytest.mark.django_db
@patch("jadawel.core.user_sources.service.user_source_updated")
...
@pytest.mark.django_db
@patch("jadawel.core.user_sources.service.user_source_moved")

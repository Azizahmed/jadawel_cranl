...
@pytest.mark.django_db
@patch("jadawel.core.notifications.signals.notification_marked_as_read.send")
...
@pytest.mark.django_db
@patch("jadawel.core.notifications.signals.all_notifications_marked_as_read.send")
...
@pytest.mark.django_db
@patch("jadawel.core.notifications.signals.all_notifications_cleared.send")

...
from jadawel.api.notifications.serializers import NotificationRecipientSerializer
from jadawel.core.models import UserProfile, WorkspaceUser
from jadawel.core.notifications.exceptions import NotificationDoesNotExist
from jadawel.core.notifications.handler import (
    NotificationHandler,
    UserNotificationsGrouper,
)
from jadawel.core.notifications.models import Notification, NotificationRecipient
from jadawel.core.notifications.registries import (
...
@patch("jadawel.core.notifications.tasks.send_queued_notifications_to_users.delay")
...
@pytest.mark.django_db(transaction=True)
@patch("jadawel.core.notifications.handler.get_mail_connection")
def test_not_all_notification_types_are_included_in_the_email_notification_summary(
    ...
    with custom_notification_types_registered() as (
        ...
        assert (
            ...
            == "You have 1 new notification - Jadawel"
        )
...
def test_email_notifications_are_included_up_to_email_limit(
    ...
    with custom_notification_types_registered() as (TestNotification, _):
        ...
        assert (
            user_1_summary_email.get_subject()
            == f"You have {limit + 1} new notifications - Jadawel"
        )
...
def test_email_notifications_per_user_limit_with_multiple_users(
    ...
    with custom_notification_types_registered() as (TestNotification, _):
        ...
        assert u1_email.get_subject() == "You have 5 new notifications - Jadawel"
        ...
        assert u2_email.get_subject() == "You have 4 new notifications - Jadawel"

...
from jadawel.contrib.database.models import Database, Table
from jadawel.contrib.database.views.models import GridView, GridViewFieldOptions
...
from jadawel.core.operations import ReadWorkspaceOperationType
from jadawel.core.registries import ImportExportConfig, plugin_registry
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_user_updated.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_user_deleted.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_created.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_restored.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_updated.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspace_deleted.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.workspaces_reordered.send")
...
@pytest.mark.django_db
@patch("jadawel.core.handler.CoreHandler.send_workspace_invitation_email")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.application_created.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.application_updated.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.applications_reordered.send")
...
@pytest.mark.django_db
@patch("jadawel.core.signals.application_deleted.send")

...
@pytest.mark.django_db
@patch("jadawel.contrib.dashboard.data_sources.service.dashboard_data_source_deleted")
...
@pytest.mark.django_db
@patch("jadawel.contrib.dashboard.data_sources.service.dashboard_data_source_created")
...
@pytest.mark.django_db
@patch("jadawel.contrib.dashboard.data_sources.service.dashboard_data_source_updated")

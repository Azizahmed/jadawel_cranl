...
from jadawel.contrib.automation.workflows.graph_handler import NodeGraphHandler
...
@patch("jadawel.contrib.automation.workflows.graph_handler.NodeGraphHandler.get_node")

...
def test_local_jadawel_aggregate_rows_service_get_schema_name():
...
def test_local_jadawel_aggregate_rows_service_generate_schema(data_fixture):
...
def test_local_jadawel_aggregate_rows_resolve_service_formulas():
    service_type = service_type_registry.get("local_jadawel_aggregate_rows")
...
@pytest.mark.django_db
def test_create_local_jadawel_aggregate_rows_service(data_fixture):
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_prepare_values_reset_field_when_table_change(
    data_fixture,
):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    ...
    service_type = service_type_registry.get("local_jadawel_aggregate_rows")
    service = LocalJadawelAggregateRows.objects.create(
        table=view.table,
        view=view,
        field=field,
    )
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_prepare_values_incorrect_field(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_prepare_values_incompatible_aggregation_type(
    data_fixture,
):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_with_table(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
    ...
    assert result["jadawel_table_model"]
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_with_view(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_with_total(data_fixture):
    """
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_with_view_filters(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_with_service_filters(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
def test_local_jadawel_aggregate_rows_dispatch_data_with_search(data_fixture):
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_field_deleted(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_field_trashed(data_fixture):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
    dashboard = page.builder
    table = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_local_jadawel_aggregate_rows_dispatch_data_field_type_not_compatible_anymore(
    data_fixture,
):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)
...
@pytest.mark.django_db
def test_create_local_jadawel_aggregate_rows_service_with_unsupported_aggregation_type(
    data_fixture,
):
    user = data_fixture.create_user()
    page = data_fixture.create_builder_page(user=user)

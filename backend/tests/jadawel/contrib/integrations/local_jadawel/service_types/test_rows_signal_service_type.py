...
def test_local_jadawel_rows_signal_service_type_import_path(path, id_mapping, expected):
    assert (
        LocalJadawelRowsCreatedServiceType().import_path(path, id_mapping) == expected
    )

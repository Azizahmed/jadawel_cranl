...
from jadawel.contrib.database.views.view_filters import ContainsViewFilterType
...
def get_test_service_type(mixin_class):
    class FakeServiceType(mixin_class, LocalJadawelTableServiceType):
        model_class = Mock()
...
def test_local_jadawel_table_service_filterable_mixin_get_table_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceFilterableMixin)
...
def test_local_jadawel_table_service_filterable_mixin_import_export(data_fixture):
    user = data_fixture.create_user()
...
@pytest.mark.django_db()
def test_local_jadawel_table_service_filterable_mixin_compat():
    mixin = LocalJadawelTableServiceFilterableMixin()
...
@pytest.mark.django_db
def test_local_jadawel_table_service_filterable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceFilterableMixin)
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_jadawel_table_service_filterable_mixin_get_dispatch_filters_raises_exception_on_trashed_field(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceFilterableMixin)
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_jadawel_table_service_sortable_mixin_get_table_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceSortableMixin)
    user = data_fixture.create_user()
    table = data_fixture.create_database_table(user=user)
    field = data_fixture.create_text_field(name="Names", table=table)
    table_model = table.get_model()
...
@pytest.mark.django_db
def test_local_jadawel_table_service_sortable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceSortableMixin)
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_local_jadawel_table_service_sortable_mixin_get_dispatch_sorts_raises_exception_on_trashed_field(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceSortableMixin)
    user = data_fixture.create_user()
...
def test_local_jadawel_table_service_searchable_mixin_get_table_queryset(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceSearchableMixin)
...
@pytest.mark.django_db
def test_local_jadawel_table_service_searchable_mixin_get_used_field_names(
    data_fixture,
):
    service_type = get_test_service_type(LocalJadawelTableServiceSearchableMixin)
    user = data_fixture.create_user()

...
from jadawel.contrib.integrations.core.models import BODY_TYPE, HTTP_METHOD
from jadawel.contrib.integrations.core.service_types import CoreHTTPRequestServiceType
from jadawel.core.services.exceptions import UnexpectedDispatchException

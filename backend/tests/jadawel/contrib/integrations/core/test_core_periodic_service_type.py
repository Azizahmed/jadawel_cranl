...
from jadawel.contrib.automation.nodes.node_types import CorePeriodicTriggerNodeType
...
@pytest.mark.django_db
@patch(
    "jadawel.contrib.integrations.core.service_types.settings.INTEGRATIONS_PERIODIC_MINUTE_MIN",
    5,
)
...
@patch(
    "jadawel.contrib.automation.workflows.handler.AutomationWorkflowHandler.start_workflow"
)
...
@pytest.mark.django_db(transaction=True)
@patch(
    "jadawel.contrib.automation.workflows.handler.AutomationWorkflowHandler.async_start_workflow"
)

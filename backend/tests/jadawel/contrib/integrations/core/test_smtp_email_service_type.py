...
from jadawel.contrib.integrations.core.service_types import CoreSMTPEmailServiceType
...
def mock_django_email(
    ...
    with (
        patch(
            "jadawel.contrib.integrations.core.service_types.EmailMultiAlternatives",
            return_value=server_mock,
        ) as mock_email,
        patch(
            "jadawel.contrib.integrations.core.service_types.get_connection",
        ) as mock_connection,
    ):

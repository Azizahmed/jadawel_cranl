...
from jadawel.core.generative_ai.exceptions import GenerativeAIPromptError
...
def mock_ai_prompt(return_value="AI response", should_fail=False):
    ...
    return patch(
        "jadawel.core.generative_ai.generative_ai_model_types.OpenAIGenerativeAIModelType.prompt",
        side_effect=_prompt,
    )

...
from jadawel.contrib.integrations.local_baserow.models import LocalBaserowListRows
...
@pytest.mark.django_db
@patch("jadawel.contrib.integrations.local_baserow.service_types.CoreHandler")
@pytest.mark.parametrize(
    "view_sorts",
    (
        [],
...
@patch(
    "jadawel.contrib.integrations.local_baserow.service_types.get_row_serializer_class"
)

...
from jadawel.contrib.builder.elements.exceptions import (
    ElementDoesNotExist,
...
@patch("jadawel.contrib.builder.elements.service.element_created")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.elements.service.element_orders_recalculated")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.elements.service.element_deleted")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.elements.service.element_updated")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.elements.service.element_moved")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.elements.service.elements_created")

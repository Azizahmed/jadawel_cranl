...
from jadawel.contrib.builder.domains.domain_types import CustomDomainType
from jadawel.contrib.builder.domains.exceptions import DomainNotInBuilder
from jadawel.contrib.builder.domains.models import Domain
from jadawel.contrib.builder.domains.service import DomainService
from jadawel.core.exceptions import PermissionException, UserNotInWorkspace
from jadawel.core.utils import Progress


@patch("jadawel.contrib.builder.domains.service.domain_created")
...
@patch("jadawel.contrib.builder.domains.service.domain_deleted")
@pytest.mark.django_db
...
@patch("jadawel.contrib.builder.domains.service.domain_updated")
@pytest.mark.django_db
...
@patch("jadawel.contrib.builder.domains.service.domains_reordered")
@pytest.mark.django_db

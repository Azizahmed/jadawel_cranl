...
from jadawel.test_utils.helpers import AnyInt, AnyStr, setup_interesting_test_table
...
@pytest.mark.django_db
@patch(
    "jadawel.contrib.builder.api.data_sources.views.DataSourceService.dispatch_data_source"
)
@patch("jadawel.contrib.builder.api.data_sources.views.BuilderDispatchContext")
@patch(
    "jadawel.contrib.builder.api.data_sources.views.DataSourceHandler.get_data_source"
)
...
@pytest.mark.django_db
@patch(
    "jadawel.contrib.builder.api.data_sources.views.DataSourceService.dispatch_page_data_sources"
)
@patch("jadawel.contrib.builder.api.data_sources.views.BuilderDispatchContext")
@patch("jadawel.contrib.builder.api.data_sources.views.PageHandler.get_page")

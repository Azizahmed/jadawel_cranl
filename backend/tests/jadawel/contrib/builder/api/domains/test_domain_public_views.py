...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.api.domains.public_views.BuilderDispatchContext")
@patch(
    "jadawel.contrib.builder.api.domains.public_views.DataSourceService.dispatch_data_source"
)
@patch(
    "jadawel.contrib.builder.api.domains.public_views.DataSourceHandler.get_data_source"
)
...
@pytest.mark.django_db
@patch(
    "jadawel.contrib.builder.api.domains.public_views.DataSourceService.dispatch_page_data_sources"
)
@patch("jadawel.contrib.builder.api.domains.public_views.BuilderDispatchContext")
@patch("jadawel.contrib.builder.api.domains.public_views.PageHandler.get_page")

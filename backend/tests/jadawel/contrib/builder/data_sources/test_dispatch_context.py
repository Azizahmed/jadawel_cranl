...
from jadawel.contrib.builder.elements.element_types import collection_element_types
...
@patch("jadawel.contrib.builder.handler.get_builder_used_property_names")

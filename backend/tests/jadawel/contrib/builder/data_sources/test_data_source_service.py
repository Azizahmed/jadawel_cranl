...
from jadawel.contrib.builder.pages.exceptions import PageNotInBuilder
from jadawel.contrib.database.views.view_filters import EqualViewFilterType
...
@patch("jadawel.contrib.builder.data_sources.service.data_source_created")
...
def test_create_data_source_with_service_type_for_different_dispatch_type(
    ...
    service_type = service_type_registry.get("local_jadawel_upsert_row")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.data_sources.service.data_source_orders_recalculated")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.data_sources.service.data_source_deleted")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.data_sources.service.data_source_updated")
...
def test_update_data_source_with_service_type_for_different_dispatch_type(
    ...
    new_service_type = service_type_registry.get("local_jadawel_upsert_row")
...
@pytest.mark.django_db
@patch("jadawel.contrib.builder.data_sources.service.data_source_moved")
...
def test_dispatch_data_sources_excludes_unused_fields_in_non_list_data_sources(
    ...
    with patch(
        "jadawel.contrib.builder.data_sources.builder_dispatch_context.BuilderDispatchContext.public_allowed_properties",
...
def test_dispatch_data_sources_excludes_unused_fields_in_list_data_sources(
    ...
    with patch(
        "jadawel.contrib.builder.data_sources.service.BuilderDispatchContext.public_allowed_properties",
        new_callable=PropertyMock,
    ) as mock_public_allowed_properties:
        mock_public_allowed_properties.return_value = {
            "internal": internal_allowed_properties,

...
from jadawel.contrib.builder.formula_property_extractor import (
    FormulaFieldVisitor,
...
@patch("jadawel.contrib.builder.mixins.get_parse_tree_for_formula")
...
@patch(
    "jadawel.contrib.builder.formula_property_extractor.builder_data_provider_type_registry"
)

...
@patch("jadawel.contrib.builder.pages.service.page_created")
...
@patch("jadawel.contrib.builder.pages.service.page_deleted")
@pytest.mark.django_db
...
@patch("jadawel.contrib.builder.pages.service.page_updated")
@pytest.mark.django_db
...
@patch("jadawel.contrib.builder.pages.service.pages_reordered")
@pytest.mark.django_db

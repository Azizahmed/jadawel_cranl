...
from jadawel.contrib.builder.data_providers.data_provider_types import (
...
@patch(
    "jadawel.contrib.builder.data_providers.data_provider_types.FormDataProviderType.validate_data_chunk"
)
...
@patch("jadawel.contrib.builder.data_providers.data_provider_types.ElementHandler")
...
def test_previous_action_data_provider_get_data_chunk_returns_cached_result(
    ...
    with patch(
        "jadawel.contrib.builder.data_providers.data_provider_types.cache"
    ) as mock_cache:

...
from jadawel.contrib.database.data_sync.models import DataSyncSyncedProperty
from jadawel.contrib.database.data_sync.utils import compare_date

ICAL_FEED_WITH_ONE_ITEMS_WITHOUT_DTEND = """BEGIN:VCALENDAR
VERSION:2.0
PRODID:Jadawel / jadawl.site
NAME:Calendar

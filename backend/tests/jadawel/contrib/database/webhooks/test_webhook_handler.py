...
from jadawel.contrib.database.webhooks.exceptions import (
...
@override_settings(JADAWEL_WEBHOOKS_MAX_PER_TABLE=4)
...
@pytest.mark.django_db
@override_settings(JADAWEL_WEBHOOKS_MAX_CALL_LOG_ENTRIES=2)

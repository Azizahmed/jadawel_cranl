...
from jadawel.contrib.database.views.view_filters import DateMultiStepViewFilterType
...
def test_length_is_lower_than_filter_type(data_fixture):
    ...
    row_1 = model.objects.create(
        **{
            ...
            f"field_{email_field.id}": "t@jadawel.com",
    ...
    row_2 = model.objects.create(
        **{
            ...
            f"field_{email_field.id}": "te@jadawel.com",

...
VALID_FORMULA_TESTS = [
    ...
    ("tourl('jadawel.io/subpage')", "jadawel.io/subpage"),
    ("tourl('jadawel.io/subpage/?query=true')", "jadawel.io/subpage/?query=true"),
    (
        "tourl(concat('baserow.io', '/subpage/?query=true'))",
        "jadawel.io/subpage/?query=true",
    ),
    ...
    ("tourl('https://jadawel.io:3000')", "https://jadawel.io:3000"),
    ("tourl('ftp://jadawel.io/some/path')", "ftp://jadawel.io/some/path"),
    ("tourl('https://jadawel.io:3000invalid')", ""),
    ("tourl('https://jadawel.iohttps://jadawel.io')", ""),
    (
        "tourl('https://user:password@www.jadawel.io:8080/path/to/resource?search=query&filter=active#section2')",
        "https://user:password@www.jadawel.io:8080/path/to/resource?search=query&filter=active#section2",
    ),
]
...
def test_formulas_with_lookup_url_field_type(data_fixture):
            ...
            [
                {
                    ...
                    linked_table_url_field.db_column: "https://jadawel.io/1",
                },
                {
                    linked_table_primary_field.db_column: "URL #2",
                    linked_table_url_field.db_column: "https://jadawel.io/2",
                },
            ],
        )
        .created_rows
    ...
    assert rows == [
        [
            "Row #1",
            [{"id": 1, "value": "https://jadawel.io/1"}],
            "https://jadawel.io/1",
            "https://jadawel.io/1",
            [{"id": 1, "value": "https://jadawel.io/1"}],
            [{"id": 1, "value": "https://jadawel.io/1some-text"}],
            "https://jadawel.io/1",
            "https://jadawel.io/1",
            Decimal("1"),
            [{"id": 1, "value": "https://jadawel.io/1"}],
        ...
        [
            ...
            [
                {"id": 1, "value": "https://jadawel.io/1"},
                {"id": 2, "value": "https://jadawel.io/2"},
            ],
            "https://jadawel.io/1https://jadawel.io/2",
            "https://jadawel.io/1some-texthttps://jadawel.io/2",
            [
                {"id": 1, "value": "https://jadawel.io/1"},
                {"id": 2, "value": "https://jadawel.io/2"},
            ],
            [
                {"id": 1, "value": "https://jadawel.io/1some-text"},
                {"id": 2, "value": "https://jadawel.io/2some-text"},
            ],
            "https://jadawel.io/2",
            "https://jadawel.io/1",
            Decimal("2"),

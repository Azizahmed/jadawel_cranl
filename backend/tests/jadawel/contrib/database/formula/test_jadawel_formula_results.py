...
VALID_FORMULA_TESTS = [
    ...
    ("tourl('jadawl.site')", "jadawl.site"),
    ("tourl('jadawl.site/subpage')", "jadawl.site/subpage"),
    ("tourl('jadawl.site/subpage/?query=true')", "jadawl.site/subpage/?query=true"),
    (
        "tourl(concat('jadawl.site', '/subpage/?query=true'))",
        "jadawl.site/subpage/?query=true",
    ),
    ("tourl(lower('JADAWL.SITE'))", "jadawl.site"),
    ("tourl(replace('jada-l.site', '-', 'w'))", "jadawl.site"),
    ("tourl('localhost')", "localhost"),
    ("tourl('skype://call-me')", "skype://call-me"),
    ("tourl('https://jadawl.site:3000')", "https://jadawl.site:3000"),
    ("tourl('ftp://jadawl.site/some/path')", "ftp://jadawl.site/some/path"),
    ("tourl('https://jadawl.site:3000invalid')", ""),
    ("tourl('https://jadawl.sitehttps://jadawl.site')", ""),
    (
        "tourl('https://user:password@www.jadawl.site:8080/path/to/resource?search=query&filter=active#section2')",
        "https://user:password@www.jadawl.site:8080/path/to/resource?search=query&filter=active#section2",
    ),
]
...
def test_formulas_with_lookup_url_field_type(data_fixture):
            ...
            [
                {
                    ...
                    linked_table_url_field.db_column: "https://jadawl.site/1",
                },
                {
                    linked_table_primary_field.db_column: "URL #2",
                    linked_table_url_field.db_column: "https://jadawl.site/2",
                },
            ],
        )
        .created_rows
    ...
    assert rows == [
        [
            "Row #1",
            [{"id": 1, "value": "https://jadawl.site/1"}],
            "https://jadawl.site/1",
            "https://jadawl.site/1",
            [{"id": 1, "value": "https://jadawl.site/1"}],
            [{"id": 1, "value": "https://jadawl.site/1some-text"}],
            "https://jadawl.site/1",
            "https://jadawl.site/1",
            Decimal("1"),
            [{"id": 1, "value": "https://jadawl.site/1"}],
        ...
        [
            ...
            [
                {"id": 1, "value": "https://jadawl.site/1"},
                {"id": 2, "value": "https://jadawl.site/2"},
            ],
            "https://jadawl.site/1https://jadawl.site/2",
            "https://jadawl.site/1some-texthttps://jadawl.site/2",
            [
                {"id": 1, "value": "https://jadawl.site/1"},
                {"id": 2, "value": "https://jadawl.site/2"},
            ],
            [
                {"id": 1, "value": "https://jadawl.site/1some-text"},
                {"id": 2, "value": "https://jadawl.site/2some-text"},
            ],
            "https://jadawl.site/2",
            "https://jadawl.site/1",
            Decimal("2"),

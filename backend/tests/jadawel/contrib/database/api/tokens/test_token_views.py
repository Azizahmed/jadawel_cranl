...
from jadawel.contrib.database.rows.operations import DeleteDatabaseRowOperationType
from jadawel.contrib.database.tokens.handler import TokenHandler
from jadawel.contrib.database.tokens.models import Token, TokenPermission
from jadawel.contrib.database.tokens.operations import (
...
def test_update_token(api_client, data_fixture):
    ...
    url = reverse("api:database:tokens:item", kwargs={"token_id": token_1.id})
    with patch(
        "jadawel.core.handler.CoreHandler.check_permissions"

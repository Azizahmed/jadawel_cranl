...
from jadawel.test_utils.helpers import AnyStr, is_dict_subset
from tests.jadawel.contrib.database.utils import get_deadlock_error
...
def test_batch_create_rows_deadlock(api_client, data_fixture):
    ...
    with patch(
        "jadawel.contrib.database.rows.handler.RowHandler.force_create_rows"
...
def test_batch_delete_rows_deadlock(api_client, data_fixture):
    ...
    with patch(
        "jadawel.contrib.database.rows.handler.RowHandler.delete_rows"
    ) as mock_delete_rows:

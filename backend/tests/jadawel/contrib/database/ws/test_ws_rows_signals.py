...
from jadawel.contrib.database.rows import signals as row_signals
...
from jadawel.test_utils.helpers import AnyInt, register_instance_temporarily


@pytest.mark.django_db(transaction=True)
@patch("jadawel.ws.registries.broadcast_to_channel_group")
...
@patch("jadawel.ws.registries.broadcast_many_to_channel_group")
@patch("jadawel.ws.registries.broadcast_to_channel_group")

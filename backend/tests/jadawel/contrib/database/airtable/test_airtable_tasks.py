...
from jadawel.contrib.database.airtable.exceptions import AirtableShareIsNotABase
from jadawel.contrib.database.airtable.models import AirtableImportJob
from jadawel.core.jobs.cache import job_progress_key
from jadawel.core.jobs.constants import JOB_FAILED, JOB_FINISHED
from jadawel.core.jobs.models import Job
from jadawel.core.jobs.tasks import run_async_job
...
@responses.activate
@patch(
    "jadawel.contrib.database.airtable.handler"
...
@responses.activate
@patch(
    "jadawel.contrib.database.airtable.handler.AirtableHandler"

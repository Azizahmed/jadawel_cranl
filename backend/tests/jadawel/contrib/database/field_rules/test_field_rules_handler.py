...
from jadawel.contrib.database.field_rules.models import FieldRule
from jadawel.contrib.database.table.models import GeneratedTableModel
from tests.jadawel.contrib.database.utils import DummyFieldRuleType
...
@pytest.mark.django_db
@mock.patch("jadawel.contrib.database.field_rules.handlers.field_rule_created.send")
@mock.patch("jadawel.contrib.database.field_rules.handlers.field_rule_updated.send")
@mock.patch("jadawel.contrib.database.field_rules.handlers.field_rule_deleted.send")

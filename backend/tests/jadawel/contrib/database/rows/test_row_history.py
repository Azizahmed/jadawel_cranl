...
from jadawel.api.sessions import get_untrusted_client_session_id
...
from jadawel.contrib.database.trash.trash_types import RowTrashableItemType
from jadawel.core.action.handler import ActionHandler
from jadawel.core.action.registries import ActionType, action_type_registry
from jadawel.core.trash.actions import RestoreFromTrashActionType
...
def test_update_rows_insert_entries_in_linked_rows_history_in_multiple_tables(
    ...
    with (
        ...
        patch(
            "jadawel.contrib.database.rows.signals.rows_history_updated.send"
        ) as mock_signal,
    ):
        action_type_registry.get_by_type(UpdateRowsActionType).do(
            user,
...
@pytest.mark.django_db
@pytest.mark.row_history
@pytest.mark.enable_signals("jadawel.ws.tasks.broadcast_to_users.delay")

...
def test_get_set_export_serialized_value_multiple_collaborators_field(data_fixture):
    user = data_fixture.create_user(email="user1@jadawel.io")
    user_2 = data_fixture.create_user(email="user2@jadawel.io")
    user_3 = data_fixture.create_user(email="user3@jadawel.io")
...
def test_export_import_multiple_collaborators_default_value_across_workspaces(
    ...
    user = data_fixture.create_user(email="shared@jadawel.io", first_name="Shared")
    user_2 = data_fixture.create_user(
        email="only_source@jadawel.io", first_name="OnlySource"
    )
...
def test_multiple_collaborators_field_type_sorting(
    ...
    user = data_fixture.create_user(email="user1@jadawel.io", first_name="User 1")
    user_2 = data_fixture.create_user(email="user2@jadawel.io", first_name="User 2")
    user_3 = data_fixture.create_user(email="user3@jadawel.io", first_name="User 3")
    database = data_fixture.create_database_application(user=user, name="Placeholder")

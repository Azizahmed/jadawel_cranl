...
from jadawel.contrib.database.fields.field_helpers import (
...
from jadawel.contrib.database.views.models import FormView, ViewFilter
...
@pytest.mark.django_db
@patch("jadawel.contrib.database.fields.signals.field_created.send")
...
@pytest.mark.django_db
@patch("jadawel.contrib.database.fields.signals.field_deleted.send")

...
from jadawel.contrib.database.fields.periodic_field_update_handler import (
    PeriodicFieldUpdateHandler,
)
from jadawel.contrib.database.fields.registries import field_type_registry
from jadawel.contrib.database.fields.tasks import (
...
def test_run_periodic_fields_updates_if_necessary(data_fixture, settings):
    ...
    with (
        patch(
            "jadawel.contrib.database.fields.tasks._run_periodic_field_type_update_per_workspace"

...
def test_last_modified_by_field_type_sorting(data_fixture):
    user_a = data_fixture.create_user(email="user1@jadawel.io", first_name="User a")
    user_b = data_fixture.create_user(email="user2@jadawel.io", first_name="User b")
    user_c = data_fixture.create_user(email="user3@jadawel.io", first_name="User c")

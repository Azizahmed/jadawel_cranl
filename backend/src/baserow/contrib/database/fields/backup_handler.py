...
class FieldDataBackupHandler:
    """
    Backs up an arbitrary Jadawel field by getting their model fields and deciding how
    ...
    useful for backing up the data due to Jadawel actions to facilitate undoing them.
    ...
    class even if the Field/Table etc has been permanently deleted from Jadawel.
    """
    ...
    def backup_field_data(
        ...
        :param field_to_backup: A Jadawel field that you want to backup the data for.
    ...
    def restore_backup_data_into_field(
        ...
        backed up data back into an existing Jadawel field of the same type.
        """

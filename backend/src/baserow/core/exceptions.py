...
class LockConflict(Exception):
    ...
    Jadawel has been locked for some operation.
    """
...
class MaxLocksPerTransactionExceededException(Exception):
    """
    Jadawel can sometimes perform operations that require a Postgres LOCK on a large
    ...
    message = (
        "Jadawel has exceeded the maximum number of PostgreSQL locks per transaction. "
    )
...
class DuplicateApplicationMaxLocksExceededException(
    ...
    message = (
        "Jadawel attempted to duplicate an application, but exceeded the maximum "

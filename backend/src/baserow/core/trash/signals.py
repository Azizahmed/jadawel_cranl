...
"""
Sent immediately before any trashable item in Jadawel is permanently deleted, so that
...
"""
Sent when any trashable item in Jadawel is permanently deleted with kwargs containing:

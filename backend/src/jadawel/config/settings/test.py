...
# Look into tests.jadawel.api.test_api_utils.py if you need to test the throttle
...
if "jadawel.middleware.ConcurrentUserRequestsMiddleware" in MIDDLEWARE:
    MIDDLEWARE.remove("jadawel.middleware.ConcurrentUserRequestsMiddleware")

...
from jadawel.contrib.builder.pages.types import (
    PagePathParams,
    PageQueryParam,
    PageQueryParams,
)
from jadawel.contrib.builder.types import PageDict
...
from jadawel.core.psycopg import is_unique_violation_error
from jadawel.core.storage import ExportZipFile
from jadawel.core.user_sources.user_source_user import UserSourceUser
from jadawel.core.utils import ChildProgressBuilder, MirrorDict, find_unused_name
    ...
    def import_elements(
        ...
        while True:
            orphans = {
                ...
                if e["id"] not in dropped_ids and e["parent_element_id"] in dropped_ids
            }
            if not orphans:
                break
            dropped_ids |= orphans

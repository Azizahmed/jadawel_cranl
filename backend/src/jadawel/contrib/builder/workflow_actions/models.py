...
from jadawel.contrib.builder.elements.models import Element, NavigationElementMixin
from jadawel.contrib.builder.pages.models import Page
from jadawel.core.formula.field import FormulaField
from jadawel.core.mixins import OrderableMixin
from jadawel.core.registry import ModelRegistryMixin
...
class LocalJadawelCreateRowWorkflowAction(BuilderWorkflowServiceAction): ...


class LocalJadawelUpdateRowWorkflowAction(BuilderWorkflowServiceAction): ...


class LocalJadawelDeleteRowWorkflowAction(BuilderWorkflowServiceAction): ...

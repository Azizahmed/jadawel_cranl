...
from jadawel.contrib.builder.constants import IMPORT_SERIALIZED_IMPORTING
...
from jadawel.contrib.builder.theme.registries import theme_config_block_registry
from jadawel.contrib.builder.types import BuilderDict
...
def lazy_get_instance_serializer_class():
    from jadawel.contrib.builder.api.serializers import BuilderSerializer

    return BuilderSerializer


def lazy_get_instance_public_serializer_class():
    from jadawel.contrib.builder.api.domains.serializers import PublicBuilderSerializer
...
class BuilderApplicationType(ApplicationType):
    ...
    def serializer_field_overrides(self):
        ...
        from jadawel.contrib.builder.api.validators import (
    ...
    def init_application(self, user: AbstractUser, application: Application) -> None:
        ...
        # Create the Local Jadawel integration.

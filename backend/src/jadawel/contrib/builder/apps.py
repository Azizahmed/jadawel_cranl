...
class BuilderConfig(AppConfig):
    ...
    def ready(self):
        ...
        from jadawel.contrib.builder.data_sources.object_scopes import (
            BuilderDataSourceObjectScopeType,
        )
        from jadawel.contrib.builder.domains.object_scopes import (
            BuilderDomainObjectScopeType,
        )
        from jadawel.contrib.builder.elements.object_scopes import (
            BuilderElementObjectScopeType,
        )
        from jadawel.contrib.builder.object_scopes import BuilderObjectScopeType
        from jadawel.contrib.builder.pages.object_scopes import (
            BuilderPageObjectScopeType,
        )
        from jadawel.contrib.builder.workflow_actions.object_scopes import (
        ...
        from jadawel.contrib.builder.elements.usage_types import (
        ...
        from jadawel.contrib.builder.pages.operations import (
        ...
        from jadawel.contrib.builder.domains.operations import (
        ...
        from jadawel.contrib.builder.domains.job_types import PublishDomainJobType
        from jadawel.contrib.builder.pages.job_types import DuplicatePageJobType
        ...
        from jadawel.contrib.builder.elements.operations import (
        ...
        from jadawel.contrib.builder.workflow_actions.receivers import (

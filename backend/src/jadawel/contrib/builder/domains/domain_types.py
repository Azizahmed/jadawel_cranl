...
from jadawel.contrib.builder.domains.exceptions import SubDomainHasInvalidDomainName
from jadawel.contrib.builder.domains.models import CustomDomain, SubDomain

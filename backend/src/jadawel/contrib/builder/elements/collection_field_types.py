...
from jadawel.contrib.builder.elements.models import CollectionField, LinkElement
from jadawel.contrib.builder.elements.registries import CollectionFieldType
...
class LinkCollectionFieldType(CollectionFieldType):
    ...
    def after_register(self):
        ...
        from jadawel.contrib.builder.elements.receivers import (

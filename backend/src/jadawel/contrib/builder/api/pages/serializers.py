...
from jadawel.contrib.builder.pages.constants import PAGE_PARAM_TYPE_CHOICES
from jadawel.contrib.builder.pages.models import Page
from jadawel.contrib.builder.pages.validators import (
...
class PageSerializer(serializers.ModelSerializer):
    """
    👉 Mind to update the
    jadawel.contrib.builder.api.domains.serializer.PublicPageSerializer

...
from jadawel.contrib.builder.api.domains.public_views import (
...
from jadawel.contrib.builder.api.domains.views import (
...
app_name = "jadawel.contrib.builder.api.domains"

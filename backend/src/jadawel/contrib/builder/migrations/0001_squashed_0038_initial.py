...
import jadawel.contrib.builder.domains.models
import jadawel.contrib.builder.elements.models
import jadawel.contrib.builder.pages.validators
import jadawel.core.fields
import jadawel.core.formula.field
import jadawel.core.mixins
from jadawel.contrib.builder.domains.models import CustomDomain, Domain


# jadawel.contrib.builder.migrations.0006_delete_all_pages
...
# jadawel.contrib.builder.migrations.0008_change_page_params
...
# jadawel.contrib.builder.migrations.0019_sub_domains
def sub_domains_0019():
    return jadawel.contrib.builder.domains.models.get_default_domain_content_type().id
...
# jadawel.contrib.builder.migrations.0020_migrate_existing_domains
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(jadawel.core.mixins.OrderableMixin, models.Model),
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=models.SET(
                            jadawel.contrib.builder.elements.models.get_default_element_content_type
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("value", jadawel.core.formula.field.FormulaField(default="")),
                (
                    "level",
                    models.IntegerField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            jadawel.contrib.builder.domains.models.validate_domain
                        ],
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="/",
                max_length=255,
                validators=[jadawel.contrib.builder.pages.validators.path_validation],
            ),
        ...
        migrations.AlterField(
            model_name="element",
            name="updated_on",
            field=jadawel.core.fields.SyncedDateTimeField(auto_now=True),
        ),
        migrations.AlterField(
            model_name="page",
            name="updated_on",
        ...
        migrations.CreateModel(
            ...
            bases=(jadawel.core.mixins.FractionOrderableMixin, models.Model),
        ),
        migrations.AddField(
            model_name="element",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "builder",
                    jadawel.core.fields.AutoOneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=models.SET(
                    jadawel.contrib.builder.domains.models.get_default_domain_content_type
                ),
                related_name="builder_domains",
                to="contenttypes.contenttype",
                verbose_name="content type",
        ...
        migrations.CreateModel(
            ...
            bases=(
                jadawel.core.mixins.PolymorphicContentTypeMixin,
                jadawel.core.mixins.OrderableMixin,
                models.Model,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", jadawel.core.formula.field.FormulaField(default="")),
                ("description", jadawel.core.formula.field.FormulaField(default="")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", jadawel.core.formula.field.FormulaField(default="")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submit_button_label",
                    jadawel.core.formula.field.FormulaField(default=""),
                ),
                (
                    "button_color",
                    models.CharField(

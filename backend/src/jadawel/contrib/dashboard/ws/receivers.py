...
from jadawel.contrib.dashboard.data_sources import signals as data_source_signals
from jadawel.contrib.dashboard.widgets import signals as widget_signals

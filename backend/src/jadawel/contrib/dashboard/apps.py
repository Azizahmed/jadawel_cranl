...
class DashboardConfig(AppConfig):
    name = "jadawel.contrib.dashboard"
    ...
    def ready(self):
        ...
        from jadawel.contrib.dashboard.object_scopes import DashboardObjectScopeType

        object_scope_type_registry.register(DashboardObjectScopeType())

        from jadawel.contrib.dashboard.data_sources.object_scopes import (
            DashboardDataSourceObjectScopeType,
        )

        object_scope_type_registry.register(DashboardDataSourceObjectScopeType())

        from jadawel.contrib.dashboard.widgets.object_scopes import (
        ...
        from jadawel.contrib.dashboard.widgets.widget_types import SummaryWidgetType

        widget_type_registry.register(SummaryWidgetType())

        from jadawel.contrib.dashboard.widgets.trash_types import (

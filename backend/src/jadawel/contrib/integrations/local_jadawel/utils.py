...
from jadawel.contrib.database.api.fields.serializers import DurationFieldSerializer
from jadawel.contrib.integrations.local_jadawel.models import LocalJadawelUpsertRow
...
def guess_cast_function_from_response_serializer_field(
    serializer_field: Union[Field, Serializer], service: LocalJadawelUpsertRow
) -> Optional[Callable]:
    """

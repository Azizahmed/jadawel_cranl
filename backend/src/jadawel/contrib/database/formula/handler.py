...
from jadawel.contrib.database.formula.types.typer import (
    calculate_typed_expression,
    recreate_formula_field_if_needed,
)
from jadawel.contrib.database.formula.types.visitors import (
...
class FormulaHandler(metaclass=baserow_trace_methods(tracer)):
    ...
    def get_normal_field_reference_expression(
        ...
        :return: A Jadawel Expression that can be used in internal formulas to represent
    ...
    def raw_formula_to_untyped_expression(cls, formula_string):
        ...
        :param formula_string: A string containing a formula in the Jadawel Formula
            expression language.
        """
    ...
    def get_typed_internal_expression_from_field(
        ...
        :param formula_field: The formula field instance to get the internal
            expression for.
        :return: A typed internal Jadawel Expression.
        """

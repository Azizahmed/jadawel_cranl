...
class FormulaMigration:
    """
    Represents how to migrate to a particular version of the Jadawel formula language.
    """
...
# A list containing all Jadawel formula versions and how to migrate to them. The last

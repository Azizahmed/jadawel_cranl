...
from jadawel.celery_singleton_backend import SingletonAutoRescheduleFlag
...
@app.task(
    name="jadawel.contrib.database.search.tasks.schedule_update_search_data",
    queue="export",
)
...
@app.task(
    name="jadawel.contrib.database.search.tasks.update_search_data",
    queue="export",
    base=Singleton,
    unique_on="table_id",
...
@app.task(
    name="jadawel.contrib.database.search.tasks.periodic_check_pending_search_data",
    queue="export",
    base=Singleton,
    raise_on_duplicate=False,
...
def periodic_check_pending_search_data():
    ...
    from jadawel.contrib.database.search.handler import SearchHandler
    from jadawel.contrib.database.table.models import Field

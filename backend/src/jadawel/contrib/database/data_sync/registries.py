...
from jadawel.contrib.database.data_sync.export_serialized import (
    DataSyncExportSerializedStructure,
)
from jadawel.contrib.database.data_sync.models import DataSync, DataSyncSyncedProperty
...
class DataSyncProperty(ABC):
    ...
    def to_jadawel_field(self) -> Field:
        ...
        :return: An unsaved Jadawel field model object.
        """
...
class DataSyncType(
    ...
    """
    By default, a data sync type is one way, allowing data to be pulled into Jadawel.

...
from jadawel.contrib.database.operations import CreateTableDatabaseTableOperationType
from jadawel.contrib.database.rows.handler import RowHandler
from jadawel.contrib.database.rows.types import CreatedRowsData
from jadawel.contrib.database.search.handler import SearchHandler
from jadawel.contrib.database.table.models import Table
from jadawel.contrib.database.table.operations import UpdateDatabaseTableOperationType
        ...
        for synced_property in synced_properties:
            ...
            if synced_property not in enabled_property_keys:
                ...
                if (
                    ...
                    # in the local Jadawel data sync to map the select option cell
                    # values.

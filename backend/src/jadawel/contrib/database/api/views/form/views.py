...
from jadawel.contrib.database.api.fields.errors import ERROR_FIELD_DATA_CONSTRAINT
...
from jadawel.contrib.database.api.views.utils import get_public_view_authorization_token
...
from jadawel.contrib.database.views.models import FormView
...
class FormUploadFileView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "Uploads a file anonymously to Jadawel by uploading the file "

...
import jadawel.contrib.database.webhooks.validators
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        validators=[
                            (
                                jadawel.contrib.database.webhooks.validators.header_name_validator
                            )
                        ]
                    ),
                ),
                (
                    ...
                    models.TextField(
                        validators=[
                            (
                                jadawel.contrib.database.webhooks.validators.header_value_validator
                            )
                        ]
                    ),
                ),

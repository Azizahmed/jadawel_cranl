...
import jadawel.contrib.database.fields.fields
...
def forward(apps, schema_editor):
    ...
    sequence_name = (
        jadawel.contrib.database.fields.fields.SerialField.get_sequence_name(
            db_table, db_column
        )
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=jadawel.contrib.database.fields.fields.SerialField(null=True),
        ),

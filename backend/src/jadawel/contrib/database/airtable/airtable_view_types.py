...
from jadawel.contrib.database.airtable.registry import AirtableViewType
from jadawel.contrib.database.fields.field_types import FileFieldType
...
from jadawel.contrib.database.views.view_types import GalleryViewType, GridViewType
...
class GridAirtableViewType(AirtableViewType):
    ...
    def prepare_view_object(
        ...
        # Set the row height if the value size is available. Jadawel doesn't support
...
class GalleryAirtableViewType(AirtableViewType):
    ...
    def get_cover_column(
        ...
        field is compatible with the cover type Jadawel. If all is True, it returns

...
from jadawel.contrib.database.fields.utils.duration import D_H, H_M_S_SSS
    ...
    def to_number_field(
        ...
        if separator_format != "" and number_separator == "":
            import_report.add_failed(
                ...
                f"{separator_format} was dropped because it doesn't exist in Jadawel.",
            )
    ...
    def to_baserow_field(
        ...
        if relationship != "many":
            import_report.add_failed(
                ...
                f"relationship was dropped because it's not supported by Jadawel.",
            )
        ...
        if filters_for_record_selection is not None:
            import_report.add_failed(
                ...
                f"was dropped because it's not supported by Jadawel.",
            )
        ...
        if ai_matching_options is not None:
            import_report.add_failed(
                ...
                f"dropped because it's not supported by Jadawel.",
            )

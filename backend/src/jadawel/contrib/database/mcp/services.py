...
def create_table(
    ...
    """
    from jadawel.contrib.database.fields.actions import CreateFieldActionType
...
def update_table(
    ...
    """Rename a table."""
    from jadawel.contrib.database.table.actions import UpdateTableActionType
...
def delete_table(user: AbstractUser, workspace: Workspace, table_id: int) -> None:
    ...
    from jadawel.contrib.database.table.actions import DeleteTableActionType
...
def delete_fields(
    ...
    from jadawel.contrib.database.fields.actions import DeleteFieldActionType
...
def create_rows(
    ...
    from jadawel.contrib.database.rows.actions import CreateRowsActionType
...
def delete_rows(
    ...
    """Delete rows by ID."""
    from jadawel.contrib.database.rows.actions import DeleteRowsActionType

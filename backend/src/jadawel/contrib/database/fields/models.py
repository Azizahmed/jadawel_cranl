...
from jadawel.contrib.database.fields.mixins import (
    DATE_FORMAT_CHOICES,
...
from jadawel.core.utils import remove_special_characters, to_snake_case

from .fields import SerialField

if TYPE_CHECKING:
    from jadawel.contrib.database.fields.dependencies.handler import FieldDependants
    from jadawel.contrib.database.fields.registries import FieldType  # noqa: F401
...
class Field(
    ...
    """
    Jadawel base field model. All custom fields should inherit from this class.
    ...
    db_index = models.BooleanField(
        db_default=False,
        default=False,
        help_text="If true, then an index will be added to the Jadawel field to "
...
class PasswordField(Field):
    allow_endpoint_authentication = models.BooleanField(
        ...
        "correct. This can be used to use Jadawel as authentication backend.",
    )
...
class DuplicateFieldJob(
    ...
    original_field = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        help_text="The Jadawel field to duplicate.",
    )
    ...
    duplicated_field = models.OneToOneField(
        ...
        on_delete=models.SET_NULL,
        help_text="The duplicated Jadawel field.",
    )

...
from jadawel.contrib.database.webhooks.models import TableWebhook, TableWebhookEvent
from jadawel.core.registry import Instance, ModelRegistryMixin, Registry

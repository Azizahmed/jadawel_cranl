...
from jadawel.core.utils import extract_allowed, set_allowed_attrs
...
class WebhookHandler:
    ...
    def create_table_webhook(
        ...
        **kwargs: dict,
        ...
        if webhook_count >= settings.JADAWEL_WEBHOOKS_MAX_PER_TABLE:
    ...
    def make_request(
        ...
        response = request(
            ...
            headers=headers,
            json=payload,
            timeout=settings.JADAWEL_WEBHOOKS_REQUEST_TIMEOUT_SECONDS,
        )
    ...
    def get_headers(self, event_type: str, event_id: str):
        ...
        return {
            ...
            "X-Jadawel-Event": event_type,
            "X-Jadawel-Delivery": str(event_id),
        }
    ...
    def clean_webhook_calls(self, webhook: TableWebhook):
        ...
        will never exceed the `JADAWEL_WEBHOOKS_MAX_CALL_LOG_ENTRIES` setting.
        ...
        calls_to_keep = (
            ...
            .values_list("id", flat=True)[
                : settings.JADAWEL_WEBHOOKS_MAX_CALL_LOG_ENTRIES
            ]
        )

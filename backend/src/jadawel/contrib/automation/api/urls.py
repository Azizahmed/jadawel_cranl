...
from jadawel.contrib.automation.api.nodes import urls as node_urls
from jadawel.contrib.automation.api.workflows import urls as workflow_urls

app_name = "jadawel.contrib.automation.api"

...
class LocalJadawelRowsCreatedTriggerNode(AutomationTriggerNode): ...


class LocalJadawelRowsUpdatedTriggerNode(AutomationTriggerNode): ...


class LocalJadawelRowsDeletedTriggerNode(AutomationTriggerNode): ...
...
class LocalJadawelCreateRowActionNode(AutomationActionNode): ...


class LocalJadawelUpdateRowActionNode(AutomationActionNode): ...


class LocalJadawelDeleteRowActionNode(AutomationActionNode): ...


class LocalJadawelGetRowActionNode(AutomationActionNode): ...


class LocalJadawelListRowsActionNode(AutomationActionNode): ...


class LocalJadawelAggregateRowsActionNode(AutomationActionNode): ...

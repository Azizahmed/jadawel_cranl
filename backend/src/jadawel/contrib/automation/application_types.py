...
from jadawel.contrib.automation.automation_init_application import (
    AutomationApplicationTypeInitApplication,
)
from jadawel.contrib.automation.constants import IMPORT_SERIALIZED_IMPORTING
...
from jadawel.contrib.automation.types import AutomationDict
...
def lazy_get_instance_serializer_class():
    from jadawel.contrib.automation.api.serializers import AutomationSerializer
...
class AutomationApplicationType(ApplicationType):
    ...
    def init_application(self, user: AbstractUser, application: Automation) -> None:
        """
        Responsible for creating an initial workflow, and Local Jadawel integration,

...
from jadawel.api.applications.errors import (
    ERROR_APPLICATION_DOES_NOT_EXIST,
    ERROR_APPLICATION_OPERATION_NOT_SUPPORTED,
)
from jadawel.api.authentication import JSONWebTokenAuthentication
...
from jadawel.api.user.errors import (
    ERROR_INVALID_CREDENTIALS,
    ERROR_INVALID_REFRESH_TOKEN,
    ERROR_REFRESH_TOKEN_ALREADY_BLACKLISTED,
)
from jadawel.api.user.views import BlacklistJSONWebToken
from jadawel.api.user_sources.errors import (
...
from jadawel.api.user_sources.schemas import authenticate_schema, refresh_schema
from jadawel.api.user_sources.serializers import (
...
from jadawel.core.app_auth_providers.exceptions import (
    AppAuthenticationProviderTypeDoesNotExist,
    IncompatibleUserSourceType,
)
from jadawel.core.auth_provider.exceptions import CannotCreateAuthProvider
from jadawel.core.exceptions import (
    ApplicationDoesNotExist,
    ApplicationOperationNotSupported,
)
from jadawel.core.handler import CoreHandler
from jadawel.core.user.exceptions import RefreshTokenAlreadyBlacklisted
from jadawel.core.user_sources.exceptions import (
    UserSourceDoesNotExist,
    UserSourceImproperlyConfigured,
    UserSourceNotInSameApplication,
)
from jadawel.core.user_sources.handler import UserSourceHandler
from jadawel.core.user_sources.jwt_token import UserSourceToken
from jadawel.core.user_sources.registries import user_source_type_registry
from jadawel.core.user_sources.service import UserSourceService
...
class UserSourceTokenRefreshView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            ...
            "on Jadawel with a user source user starting from a valid refresh token."
        ),
        responses={
            200: refresh_schema,

...
from jadawel.api.health.serializers import (
...
from jadawel.core.health.handler import HealthCheckHandler
from jadawel.core.health.utils import get_celery_queue_size
...
class EmailTesterView(APIView):
    ...
    @extend_schema(
        ...
        "testing Jadawel's email configuration as errors are clearly "
        "returned.",
        responses={

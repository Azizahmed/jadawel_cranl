...
from jadawel.api.actions.serializers import (
    UndoRedoResponseSerializer,
    get_undo_request_serializer,
)
from jadawel.api.captcha.errors import ERROR_CAPTCHA_VERIFICATION_FAILED
...
from jadawel.api.sessions import (
...
from jadawel.api.workspaces.invitations.errors import (
...
from jadawel.core.action.registries import ActionScopeStr, action_type_registry
from jadawel.core.auth_provider.exceptions import (
    AuthProviderDisabled,
    EmailVerificationRequired,
)
from jadawel.core.auth_provider.handler import PasswordProviderHandler
from jadawel.core.captcha.exceptions import CaptchaVerificationFailed
from jadawel.core.captcha.handler import CaptchaHandler
...
from jadawel.core.models import Settings, Template, WorkspaceInvitation
...
class RefreshJSONWebToken(TokenRefreshView):
    ...
    @extend_schema(
        ...
        description=(
            "Generate a new access_token that can be used to continue operating on Jadawel "

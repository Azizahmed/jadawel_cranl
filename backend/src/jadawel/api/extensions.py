...
class MappingSerializerExtension(OpenApiSerializerExtension):
    ...
    target_class = "jadawel.api.utils.MappingSerializer"
...
class CustomFieldRegistryMappingSerializerExtension(MappingSerializerExtension):
    ...
    target_class = "jadawel.api.utils.CustomFieldRegistryMappingSerializer"
...
class DiscriminatorMappingSerializerExtension(OpenApiSerializerExtension):
    ...
    target_class = "jadawel.api.utils.DiscriminatorMappingSerializer"
...
class DiscriminatorCustomFieldsMappingSerializerExtension(
    ...
    target_class = "jadawel.api.utils.DiscriminatorCustomFieldsMappingSerializer"
...
class PolymorphicMappingSerializerExtensionMixin(
    ...
    target_class = "jadawel.api.polymorphic.PolymorphicSerializer"
...
class PolymorphicRequestMappingSerializerExtensionMixin(
    ...
    target_class = "jadawel.api.polymorphic.PolymorphicRequestSerializer"
    match_subclasses = True

...
from jadawel.api.user.errors import ERROR_INVALID_ACCESS_TOKEN
...
from jadawel.core.user.cache import get_cached_user, set_cached_user
...
class JSONWebTokenAuthenticationExtension(OpenApiAuthenticationExtension):
    target_class = "jadawel.api.authentication.JSONWebTokenAuthentication"
    name = "JWT"

...
from jadawel.core.trash.actions import EmptyTrashActionType, RestoreFromTrashActionType
...
class TrashItemView(APIView):
    ...
    @extend_schema(
        ...
        description="Restores the specified trashed item back into jadawel.",

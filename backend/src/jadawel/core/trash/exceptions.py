from jadawel.core.exceptions import MaxLocksPerTransactionExceededException
...
class PermanentDeletionMaxLocksExceededException(
    ...
    message = (
        "Jadawel attempted to permanently delete trashed items, but exceeded the maximum "

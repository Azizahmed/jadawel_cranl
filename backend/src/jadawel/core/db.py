...
from jadawel.core.psycopg import is_deadlock_error, sql
...
def get_collation_name() -> Optional[str]:
    """
    Performs a simple check to determine if expected Jadawel collation
    can be used by sourcing pg_collation table.

    Returns the name of the Jadawel collation if it
...
def collate_expression(expression):
    """
    If default Jadawel collation can be used

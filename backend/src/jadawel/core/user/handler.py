...
from jadawel.core.auth_provider.models import AuthProviderModel
from jadawel.core.emails import EmailPendingVerificationEmail
...
from jadawel.core.signals import (
    before_user_deleted,
    user_deleted,
...
class UserHandler(metaclass=jadawel_trace_methods(tracer)):
    ...
    def get_all_active_users_qs(self) -> QuerySet:
        ...
        Jadawel instance. Will filter out users who have be "banned/deactivated" by an

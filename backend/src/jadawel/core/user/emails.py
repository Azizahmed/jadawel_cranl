...
from jadawel.core.emails import BaseEmailMessage
...
class PasswordChangedEmail(BaseEmailMessage):
    ...
    def get_subject(self):
        return _("Password changed - جداول")
...
class AccountDeletionScheduled(BaseEmailMessage):
    ...
    def get_subject(self):
        return _("Account deletion scheduled - جداول")
...
class AccountDeleted(BaseEmailMessage):
    ...
    def get_subject(self):
        return _("Account permanently deleted - جداول")
...
class AccountDeletionCanceled(BaseEmailMessage):
    ...
    def get_subject(self):
        return _("Account deletion cancelled - جداول")
...
class ChangeEmailConfirmationEmail(BaseEmailMessage):
    ...
    def get_subject(self):
        return _("Confirm email address change - جداول")

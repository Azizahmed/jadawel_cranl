...
from jadawel.core.app_auth_providers.types import AppAuthProviderTypeDict
...
from jadawel.core.registry import EasyImportExportMixin, PublicCustomFieldsInstanceMixin

if TYPE_CHECKING:
    from jadawel.core.user_sources.types import UserSourceSubClass

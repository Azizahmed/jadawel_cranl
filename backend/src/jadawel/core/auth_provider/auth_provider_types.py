...
from jadawel.core.auth_provider.models import (
    AuthProviderModel,
    PasswordAuthProviderModel,
)
from jadawel.core.auth_provider.registries import BaseAuthProviderType
from jadawel.core.auth_provider.types import AuthProviderModelSubClass, UserInfo
from jadawel.core.auth_provider.validators import validate_domain
from jadawel.core.handler import CoreHandler
from jadawel.core.user.exceptions import UserNotFound


class AuthProviderType(BaseAuthProviderType):
    """
    Base auth provider type class for Jadawel auth providers.
    """
    ...
    def get_user_and_sign_in(
        ...
        from jadawel.core.actions import AcceptWorkspaceInvitationActionType
    ...
    def create_user(
        ...
        from jadawel.core.user.actions import CreateUserActionType
    ...
    def export_serialized(self) -> Dict[str, Any]:
        ...
        from jadawel.api.auth_provider.serializers import AuthProviderSerializer

...
def load_test_data():
    ...
    for i in range(3):
        # Create main admin
        email = f"admin{i + 1}@jadawel.io" if i > 0 else "admin@jadawel.io"
        try:
        ...
        email = f"admin{i + 1}_bis@jadawel.io" if i > 0 else "admin_bis@jadawel.io"
        try:
        ...
        for j in range(3):
            ...
            member_email = f"{member_email_prefix}@jadawel.io"
            try:

...
class Command(BaseCommand):
    help = """
        ...
        being updated and not connected to a running version of Jadawel for the
        ...
        safe you should only perform back-up's when your Jadawel server is shut down
        or you have first copied the database to a new cluster which is not in active
        use.

        The back-up is split into batches as often Jadawel database's can end up with

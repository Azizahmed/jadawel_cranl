...
class BaseOpenAIGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import BaseOpenAISettingsSerializer
...
class OpenAIGenerativeAIModelType(BaseOpenAIGenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import OpenAISettingsSerializer
...
class AnthropicGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import AnthropicSettingsSerializer
...
class MistralGenerativeAIModelType(GenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import MistralSettingsSerializer
...
class OllamaGenerativeAIModelType(BaseOpenAIGenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import OllamaSettingsSerializer
...
class OpenRouterGenerativeAIModelType(BaseOpenAIGenerativeAIModelType):
    ...
    def get_settings_serializer(self) -> type:
        from jadawel.api.generative_ai.serializers import OpenRouterSettingsSerializer

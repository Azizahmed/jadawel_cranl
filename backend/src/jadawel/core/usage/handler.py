...
from jadawel.core.utils import ChildProgressBuilder, grouper
...
class UsageHandler:
    ...
    def get_workspace_row_count_annotation(cls, outer_ref_name: str = "id") -> Coalesce:
        ...
        # FIXME: Move this to jadawel.contrib.database
        from jadawel.contrib.database.table.models import Table, TableUsageUpdate

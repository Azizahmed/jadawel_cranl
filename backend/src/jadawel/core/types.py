...
if TYPE_CHECKING:
    ...
    from jadawel.contrib.automation.models import Automation  # noqa: F401
    from jadawel.contrib.builder.models import Builder  # noqa: F401
    from jadawel.contrib.dashboard.models import Dashboard  # noqa: F401
    from jadawel.contrib.database.models import Database, Table, View  # noqa: F401

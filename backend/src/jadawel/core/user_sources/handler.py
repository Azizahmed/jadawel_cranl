...
from jadawel.core.exceptions import ApplicationOperationNotSupported
...
from jadawel.core.user_sources.types import UserSourceForUpdate
...
class UserSourceHandler:
    ...
    def _generate_update_user_count_chunk_queryset(
        ...
        batch_per_hour = (
            60 // settings.JADAWEL_ENTERPRISE_USER_SOURCE_COUNTING_TASK_INTERVAL_MINUTES
        )

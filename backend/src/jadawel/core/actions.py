...
from jadawel.core.handler import CoreHandler, WorkspaceForUpdate
...
class DeleteWorkspaceActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace: WorkspaceForUpdate):
        ...
        See jadawel.core.handler.CoreHandler.delete_workspace for more details.
...
class CreateWorkspaceActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace_name: str) -> WorkspaceUser:
        ...
        jadawel.core.handler.CoreHandler.create_workspace for more details. Undoing this
...
class UpdateWorkspaceActionType(UndoableActionType):
    ...
    def do(
        ...
        workspace. See jadawel.core.handler.CoreHandler.upgrade_workspace for more
...
class OrderWorkspacesActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, workspace_ids_in_order: List[int]) -> None:
        ...
        See jadawel.core.handler.CoreHandler.order_workspaces for more details. Undoing
...
class OrderApplicationsActionType(UndoableActionType):
    ...
    def do(
        ...
        `jadawel.core.handler.CoreHandler.order_applications` for further details. When
...
class CreateApplicationActionType(UndoableActionType):
    ...
    def do(
        ...
        jadawel.core.handler.CoreHandler.create_application for further details.
...
class DeleteApplicationActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, application: Application) -> None:
        ...
        See jadawel.core.handler.CoreHandler.delete_application for further details.
...
class UpdateApplicationActionType(UndoableActionType):
    ...
    def do(cls, user: AbstractUser, application: Application, **kwargs) -> Application:
        ...
        See jadawel.core.handler.CoreHandler.update_application for further details.
...
class DuplicateApplicationActionType(UndoableActionType):
    ...
    def do(
        ...
        See jadawel.core.handler.CoreHandler.duplicate_application for further details.
        Undoing this action trashes the application and redoing restores it.
...
class InstallTemplateActionType(UndoableActionType):
    ...
    def do(
        ...
        jadawel.core.handler.CoreHandler.install_template for further details.
...
class CreateWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into jadawel.core.handler.CoreHandler.create_workspace_invitation for
        further details.
...
class DeleteWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into jadawel.core.handler.CoreHandler.delete_workspace_invitation
        for further details.
...
class AcceptWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into jadawel.core.handler.CoreHandler.accept_workspace_invitation for
        further details.
        """
...
class RejectWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        """
        Accepts an existing workspace invitation.
        Look into jadawel.core.handler.CoreHandler.reject_workspace_invitation for
        further details.
        """
...
class UpdateWorkspaceInvitationActionType(ActionType):
    ...
    def do(
        ...
        Look into jadawel.core.handler.CoreHandler.update_workspace_invitation for
        further details.
        """
...
class LeaveWorkspaceActionType(ActionType):
    ...
    def do(cls, user: AbstractUser, workspace: Workspace):
        ...
        Look into jadawel.core.handler.CoreHandler.leave_workspace for further details.
        """

...
export default {
  ...
  methods: {
    ...
    calculatePositions(
      ...
      // Callers express `horizontal` with an LTR mindset: 'left' means "anchor the
      // edge nearest the start of the toolbar and grow towards the content", and a
      // positive horizontalOffset pushes towards physical +x. In RTL the toolbar is
      // mirrored, so both the anchor and the offset direction must mirror too or the
      // context grows off-screen. `checkForEdges` then still flips on real overflow.

    ...
    <div v-if="small" class="service-form__filter-buttons">
      ...
      >
        <div class="service-form__context-content">
          ...
          <LocalJadawelTableServiceConditionalForm
      ...
      >
        <div class="service-form__context-content">
          ...
          <LocalJadawelTableServiceSortForm
            v-if="values.table_id"
...
import LocalJadawelTableServiceConditionalForm from '@jadawel/modules/integrations/localJadawel/components/services/LocalJadawelTableServiceConditionalForm'
import LocalJadawelTableServiceSortForm from '@jadawel/modules/integrations/localJadawel/components/services/LocalJadawelTableServiceSortForm'

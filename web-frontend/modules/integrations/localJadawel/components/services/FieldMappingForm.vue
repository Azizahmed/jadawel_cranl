...
<script>
import FieldMappingContext from '@jadawel/modules/integrations/localJadawel/components/services/FieldMappingContext'
...
export default {
  ...
  computed: {
    ...
    placeholderForType() {
      ...
      return this.$t(
        `localJadawelUpsertRowServiceForm.fieldMappingPlaceholder${capitalizedType}`
      )
    },
  },
  watch: {

    ...
    >
      ...
      <ul v-if="!tableLoading" class="header__filter">
        <li v-if="showLogo" class="header__filter-item">
          <BrandLogo class="header__filter-logo" />
        </li>
...
import ViewsContext from '@jadawel/modules/database/components/view/ViewsContext'
...
import ViewDecoratorMenu from '@jadawel/modules/database/components/view/ViewDecoratorMenu'
...
import ShareViewLink from '@jadawel/modules/database/components/view/ShareViewLink'
import BrandLogo from '@jadawel/modules/core/components/BrandLogo'
import ViewGroupBy from '@jadawel/modules/database/components/view/ViewGroupBy'

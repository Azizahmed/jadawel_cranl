...
const envMapping = {
  ...
  BASEROW_USE_PG_FULLTEXT_SEARCH: 'NUXT_PUBLIC_JADAWEL_USE_PG_FULLTEXT_SEARCH',
  BASEROW_INTEGRATION_LOCAL_BASEROW_PAGE_SIZE_LIMIT:
    'NUXT_PUBLIC_INTEGRATION_LOCAL_BASEROW_PAGE_SIZE_LIMIT',
  BASEROW_ROW_PAGE_SIZE_LIMIT: 'NUXT_PUBLIC_JADAWEL_ROW_PAGE_SIZE_LIMIT',
  BASEROW_UNIQUE_ROW_VALUES_SIZE_LIMIT:
    'NUXT_PUBLIC_JADAWEL_UNIQUE_ROW_VALUES_SIZE_LIMIT',
  BASEROW_DISABLE_SUPPORT: 'NUXT_PUBLIC_JADAWEL_DISABLE_SUPPORT',
  ...
  BASEROW_PRICING_URL: 'NUXT_PUBLIC_JADAWEL_PRICING_URL',

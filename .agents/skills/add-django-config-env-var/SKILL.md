...
- `docs/CONFIGURATION.md` — the Jadawel env-var reference; add a row in the right section
...
6. Add the related documentation in `docs/CONFIGURATION.md` — find the right section (e.g. Backend Configuration, Integration Configuration) and add a table row matching the format of the nearest existing entry.
...
6. Add a row to `docs/CONFIGURATION.md` when necessary
